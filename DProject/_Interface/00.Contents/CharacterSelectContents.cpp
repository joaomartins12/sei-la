...
namespace
{
	// Posições finais para o CharacterSelect no mesmo cenário do CharacterCreate.
	// Tamer ligeiramente à esquerda; Digimon à direita e no mesmo chão/plano.
	static const float CHARACTER_SELECT_MODEL_POS_X = 2920.0f;
	static const float CHARACTER_SELECT_MODEL_POS_Y = 18114.0f;
	static const float CHARACTER_SELECT_MODEL_POS_Z = 315.0f;

	static const float CHARACTER_SELECT_TAMER_YAW = 0.0f;

	static const float CHARACTER_SELECT_DIGIMON_OFFSET_X = 130.0f;
	static const float CHARACTER_SELECT_DIGIMON_OFFSET_Z = 0.0f;
...
CTamer* CharacterSelectContents::sCharacterInfo::CreateTamer(cItemData const* pEquipInfo, uint const& unTBIdx, bool const& bGray)
{
	...
	return g_pCharMng->AddTempTamer(&prop, unTBIdx, NiPoint3(CHARACTER_SELECT_MODEL_POS_X, CHARACTER_SELECT_MODEL_POS_Y, CHARACTER_SELECT_MODEL_POS_Z), CHARACTER_SELECT_TAMER_YAW, NULL, cp, 0);
...
CDigimon* CharacterSelectContents::sCharacterInfo::CreateDigimon(uint const& unTBIdx, uint const& nEffectType, bool const& bGray)
{
	...
	CDigimon* pDigimon = g_pCharMng->AddTempDigimon(&prop, unTBIdx, NULL, NiPoint3(CHARACTER_SELECT_MODEL_POS_X + CHARACTER_SELECT_DIGIMON_OFFSET_X, CHARACTER_SELECT_MODEL_POS_Y, CHARACTER_SELECT_MODEL_POS_Z + CHARACTER_SELECT_DIGIMON_OFFSET_Z), CHARACTER_SELECT_TAMER_YAW, NULL);
...
CPat* CharacterSelectContents::sCharacterInfo::CreatePat(uint const& unPatLeader, bool const& bGray)
{
	...
	CPat* pPat = g_pCharMng->AddPat(m_pTamer, g_pCharMng->PopTempCharID(), pInfo->s_nDigimonID, &prop, NiPoint3(CHARACTER_SELECT_MODEL_POS_X + CHARACTER_SELECT_PAT_OFFSET_X, CHARACTER_SELECT_MODEL_POS_Y, CHARACTER_SELECT_MODEL_POS_Z + CHARACTER_SELECT_PAT_OFFSET_Z), CHARACTER_SELECT_TAMER_YAW);
...
void CharacterSelectContents::sCharacterInfo::CreateCharacter(sSimpleCharacterInfo const& info)
{
	...
	{
		m_pTamerDummy = Create_Dummy("Data\\EtcObject\\FigureTamer.nif", NiPoint3(CHARACTER_SELECT_MODEL_POS_X, CHARACTER_SELECT_MODEL_POS_Y, CHARACTER_SELECT_MODEL_POS_Z), CHARACTER_SELECT_TAMER_YAW);
		m_pDigimonDummy = Create_Dummy("Data\\EtcObject\\FigureDigimon.nif", NiPoint3(CHARACTER_SELECT_MODEL_POS_X + CHARACTER_SELECT_DIGIMON_OFFSET_X, CHARACTER_SELECT_MODEL_POS_Y, CHARACTER_SELECT_MODEL_POS_Z + CHARACTER_SELECT_DIGIMON_OFFSET_Z), CHARACTER_SELECT_TAMER_YAW);
	}
	else
	{
